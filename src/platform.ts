/**
 * Matterbridge platform for Mova vacuum cleaners.
...
export class MovaPlatform extends MatterbridgeDynamicPlatform {
  private cloud: MovaCloudProtocol;
  private devices: Map<string, MovaVacuumDevice> = new Map();
  private cloudDevices: Map<string, MovaDevice> = new Map(); // Store original cloud device data
  ...
  /**
   * Discover Mova vacuums and register them as Matter devices.
   */
