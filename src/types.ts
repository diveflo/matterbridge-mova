/**
 * TypeScript types and interfaces for the Matterbridge MOVA plugin.
 *
 * @file types.ts
 * @license Apache-2.0
 */
...
// On the tested MOVA S70 Roller firmware, raw 2 behaves as vacuum-only and raw 0 behaves as vacuum+mop.
export enum MovaCleaningMode {
  Sweeping = 0,
  Mopping = 1,
